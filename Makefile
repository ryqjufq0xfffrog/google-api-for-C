...
BUILDSRC = sample.c src/buffers.o src/google.o src/google_datatype.o src/shell.o
...
src/google_datatype.o: src/google_datatype.c src/google.h
	$(CC) src/google_datatype.c -c -o src/google_datatype.o
